...
public class Day01 extends AoCPuzzle {
    ...
    public void solvePart01(List<String> input) {
        List<Integer> depths = convertToInts(getFileInput());
    ...
    public void solvePart02(List<String> input) {
        List<Integer> depths = this.convertToInts(getFileInput());
        int depthIncreased = 0;
    ...
    public static void main(String[] args) {
        ...
        day01.solvePart01(day01.getFileInput());
        day01.solvePart02(day01.getFileInput());
